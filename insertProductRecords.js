...
var connection = mysql.createConnection({
  host     : 'sediss-p4.c6xzjopfczba.us-east-1.rds.amazonaws.com',
  port     : '3306',
  user     : 'admin',
  password : 'adminadmin',
  database : 'EDISS',
...
lineReader.eachLine('./InputData/ProductRecords.json', function(line, last) {
  execute = false;
...
//****************************************************Change the query to align with your schema******************************************************/
    if (numRecords == recordBlock) {
      query = `INSERT INTO product (productName, productGroup, productDescription, ASIN) VALUES ${values};`; //Template, replaces ${values} with the value of values.
      values = "";
      numRecords = 0;
      execute = true;
      // console.log(query);
